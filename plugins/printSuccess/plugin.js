...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native MyAppTest initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this myapptest : https://thecodingmachine.github.io/react-native-myapptest/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-myapptest/issues'
			);
			console.log(
				'- ⭐ If you love this myapptest, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-myapptest'
			);
